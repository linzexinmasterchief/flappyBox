...
raw_ui_start_up_img = pygame.image.load("assets\\ui_start_up.png")
raw_ui_start_down_img = pygame.image.load("assets\\ui_start_down.png")
...
start_button = UI_button(screen, raw_ui_start_up_img, raw_ui_start_down_img, 100, 50, (100, main_title_ui_height + 0))
...
def physics_thread():
    ...
    while running:
        if is_game_paused or is_menu_shown:
            continue
...
while running:
    ...
    for event in pygame.event.get():
        ...
        # key monitor
        if event.type == pygame.KEYDOWN and not is_game_over and not is_menu_shown:
            # box jump control
